...
from storeapi.models.data.databaseAPI import (
...
async def get_post_with_comments(post_id: int):
    ...
    return {"post": post_detail, "comment": comment_lists}
...
async def update_comment(comment: Comment):
    ...
    try:
        ...
        raise HTTPException(
            status_code=404,
            detail="comment with comment_id:{comment_id},post_id:{post_id} and comment:{comment_text} don't exist",
        )
